<?php include("inc/header.php"); ?> 
        <div class="grid_10">
            ...
            <div class="box round first grid">
                <h2>Add New Category|| About Us Page</h2>
               <div class="block copyblock"> 
				   ...
				   <?php 
						if(isset($_POST["submit"])){
							$name=$_POST['name'];	
							$query="INSERT INTO cat_about(name) values ('$name')";
				 ...
				 <table class="display datatable" id="example">
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td>
							<a href="edit_cat_aboutus.php?id=<?php echo $catshow['id']; ?>" class="btn_edit">Edit</a> 
							<?php 
							if (Session::get('Status')=='admin'){
							?>
							|| 
							
							<a href="delete.php?abcat=<?php echo $catshow['id']; ?>" class="btn_delete">Delete</a></td>
						<?php }?>
						</tr>
