               ...
               <div class="block copyblock"> 
				   ...
				   <?php 
						if(isset($_POST["submit"])){
							$name=$_POST['name'];	
							$query="INSERT INTO cat_teachers(name) values ('$name')";
				 ...
				 <table class="display datatable" id="example">
					...
					<tbody>
						<?php		
						$query="SELECT * FROM cat_teachers";
						...
						<tr class="odd gradeX">
							...
							<td>
							<a href="edit_cat_teachers.php?id=<?php echo $catshow['id']; ?>" class="btn_edit">Edit</a> 
							<?php 
							if (Session::get('Status')=='admin'){
							?>
							|| <a href="delete.php?tcat=<?php echo $catshow['id']; ?>" class="btn_delete">Delete</a></td>
						<?php }?>
						</tr>
