...
<head>
  ...
  <title>আদর্শ নাগরিক ফাউন্ডেশন-Adarsha Nagorik Foundation, Bangladesh.</title>
  <meta charset="utf-8">
...
<section class="top_bar" id="top_bar"  >
	<div class="container-fluid">
		...
		<div class="row div col-md-7 col-sm-9 col-xs-12 top_bar_text">
			<ul> 
				<li> <a href="jobs.php">সদস্য হোন</a></li>			
				<li> <a href="teachers.php">স্থায়ী কমিটি</a></li>			
				<li> <a href="teachers.php">জেলা ভিত্তিক কমিটি</a></li>			
				<!--<li> <a href="lawp.php">প</a></li>			-->
				<li> <a href="contact_us.php">যোগাযোগ করুন</a></li>			
			</ul>
		</div>
	</div>				
</section>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse navbar-right" id="myNavbar">
		  <ul class="nav navbar-nav">
			...
			<li class=""><a  href="notice.php"> নোটিশ বোর্ড</a></li>
			<li class="dropdown ">
			...
			<li class="dropdown ">
			  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">অন্যান্য তথ্য সমূহ <span class="caret"></span></a>
			  <ul class="dropdown-menu">
			...
			<li class="dropdown ">
			  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">ফটো গ্যালারী <span class="caret"></span></a>
			  <ul class="dropdown-menu">
				<?php		
